...
A full-stack <span style="background-color: lightblue">Marked text</span> with a front-end focus, and a `technical writer`. I love to demystify complex technical concepts. Always open to opportunities to add values in any form!
