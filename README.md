...
A full-stack <mark style="background-color: lightblue">Marked text</mark> with a front-end focus, and a `technical writer`. I love to demystify complex technical concepts. Always open to opportunities to add values in any form!
